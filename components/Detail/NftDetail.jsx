...
const NFTDetail = ({ category, subcategory, tokenId }) => {
  ...
  return (
    <div>
      ...
      <div className="md:my-12 my-6 text-black">
        {isLoading && <Loading />}
        ...
        {!isLoading && data !== null && (
          <>
            <div className="hidden md:flex flex-row items-center md:space-x-8 space-x-2">
              <PreviousButton
            ...
            <div className="md:hidden flex flex-col items-center  space-y-6">
              <div className="bg-white md:py-16 md:px-10 px-2 py-2 rounded-lg w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 gap-0">
                  <div>
                    <img
                      src={
                  ...
                  <div>
                    <h1 className="text-3xl font-semibold text-black capitalize mt-6">
                      {data?.asset?.name}
                    </h1>
                    <p className="text-base text-orange font-semibold capitalize">
                      {data?.asset?.category}
